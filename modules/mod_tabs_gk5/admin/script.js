...
var TabsGK5Settings = new Class({
	...
	initialize: function() {
		...
		// enable drag'n'drop
		$this.options.sortables = new Sortables(document.id('tabs_list'), {
			clone: true, 
			opacity: 0.5, 
	...
	formInit: function() {
		...
		var link = new Element('a', { 'class' : 'gkHelpLink', 'href' : 'http://www.gavick.com/tabs-gk-5.html', 'target' : '_blank' })
