                        ...
                        <ul>
                              ...
                              <li>
                                  <time datetime="<?php echo JHtml::_('date', $this->item->created, 'Y-m-d'); ?>">
                                    ...
                                    <span><?php echo JHTML::_('date', $article_time, "M"); ?></span>
                                  </time>
                              </li>
                              <?php endif; ?>
  ...
  $this->item->params->get('itemAttachments')
      ...
      <div class="itemAuthorBlock">
            ...
            <div class="itemAuthorAvatar">
            	<img class="itemAuthorAvatar" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" /></div>
            <?php endif; ?>
            <div class="itemAuthorDetails clearfix<?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)):?> leftmargin<?php endif; ?>">
                  <div class="clearfix">
      ...
      <div class="itemComments">
            ...
            <ul class="itemCommentsList">
                  ...
                  <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
                        ...
                        <div class="commentAuthorAvatar"><img src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" /></div>
                        <?php endif; ?>
                        <div>
                              ...
                              <span class="commentDate">
                                <time datetime="<?php echo JHtml::_('date', $comment->commentDate, 'Y-m-d'); ?>">
            ...
            <div class="itemCommentsPagination clearfix">
